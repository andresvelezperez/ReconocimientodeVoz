/*
 *	Paquete				: espectro
 *	Archivo				: MelFrequencyFilterBank.java
 ...
 *	edu.cmu.sphinx.frontend.frequencywarp.MelFrequencyFilterBank.java
 *
...
public class MelFrequencyFilterBank {
	...
	public MelFrequencyFilterBank(float minFreq,float maxFreq,int numberFilters,int sampleRate)
	{
    ...
    public double[] process(double[] input)
            throws IllegalArgumentException {
        double[] in = (double[])input.clone();
        
        if (filter == null || sampleRate != 0) {
